...
def matlab_style_gauss2D(shape: Tuple[int, int], sigma: float = 1.0) -> np.ndarray | None:
...
def interpolate(x: np.ndarray, y: np.ndarray, points: np.ndarray, type: str) -> np.ndarray:
