...
class TestInterpolateFunctions(unittest.TestCase):
    def test_matlab_style_gauss2D(self):
        ...
        expected_kernel = np.array([[0.00296902, 0.01330621, 0.02193823, 0.01330621, 0.00296902],
        ...
        expected_kernel = np.array([[0.02324684, 0.03382395, 0.03832756, 0.03382395, 0.02324684],
    ...
    def test_interpolate(self):
        ...
        np.testing.assert_almost_equal(quadratic_interp, expected_quadratic_interp, decimal=1)
